...
/**
 * A {@code LoopingAnimation} implements the interface {@link Animation} and should be used when the {@link Animation}
 * should loop. For different behaviour, look at the other classes that implement {@link Animation}.
 */
public record LoopingAnimation(int rowStart, int columnStart, int rowEnd, int columnEnd,
     ...
     */
    public LoopingAnimation(final int rowStart, final int columnStart, final int rowEnd, final int columnEnd) {
