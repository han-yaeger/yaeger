...
public abstract class YaegerApplication extends Application {
     ...
     *
     * <p>To create a {@link YaegerScene} extend either a {@link nl.han.yaeger.engine.scenes.StaticScene} or a
     * {@link nl.han.yaeger.engine.scenes.DynamicScene}. A {@link nl.han.yaeger.engine.scenes.StaticScene} should
     * be used for simple screens that do not need the Game world Update cycle. If such an cycle is required, extend
     * a {@link nl.han.yaeger.engine.scenes.DynamicScene}.
     * </p>
     */
