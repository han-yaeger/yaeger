...
import nl.han.yaeger.engine.Activatable;
...
import nl.han.yaeger.engine.entities.entity.Anchorable;
...
import nl.han.yaeger.engine.exceptions.EntityNotAvailableException;
 ...
 * the full width of the {@link nl.han.yaeger.engine.scenes.YaegerScene} must be used for placing the tiles.
...
public abstract class TileMap extends EntitySupplier implements Anchorable, Activatable {
     ...
     * {@link nl.han.yaeger.engine.scenes.YaegerScene}.
     */
    public TileMap() {
     ...
     * and height of the {@link nl.han.yaeger.engine.scenes.YaegerScene} to calculate the placement
