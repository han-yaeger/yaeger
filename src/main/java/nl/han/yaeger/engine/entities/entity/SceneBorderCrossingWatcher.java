...
/**
 * Implement this interface to be notified if the {@link YaegerEntity} crosses the boundary of the {@link nl.han.yaeger.engine.scenes.YaegerScene}.
...
public interface SceneBorderCrossingWatcher extends Bounded, SceneChild {
     ...
     *
     * @param border The border of the {@link nl.han.yaeger.engine.scenes.YaegerScene} the {@link YaegerEntity} is crossing.
     */
