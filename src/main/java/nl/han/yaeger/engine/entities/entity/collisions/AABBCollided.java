...
/**
 * A {@link AABBCollided} represents an non-rotatable {@link nl.han.yaeger.engine.entities.entity.Entity} that can be collided with by a
 * {@link Collider}. In such a case, the {@link AABBCollided} is the {@link nl.han.yaeger.engine.entities.entity.Entity} that
 ...
 * <emph></>Axis-Aligned Bounding Box</emph> collision detection, which required the instances of {@link nl.han.yaeger.engine.entities.entity.Entity}
