...
/**
 * Being a {@link MouseExitListener} enables the {@link nl.han.yaeger.engine.entities.entity.YaegerEntity} to be notified if the Mouse Cursor has
 * exited the area defined by the {@link javafx.geometry.BoundingBox} of an {@link nl.han.yaeger.engine.entities.entity.YaegerEntity}.
 */
