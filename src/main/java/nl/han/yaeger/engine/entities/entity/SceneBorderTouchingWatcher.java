...
/**
 * Implement this interface to be notified if the {@link Entity} touches the boundary of the {@link nl.han.yaeger.engine.scenes.YaegerScene}.
...
public interface SceneBorderTouchingWatcher extends Bounded, SceneChild {
     ...
     *
     * @param border The border of the {@link nl.han.yaeger.engine.scenes.YaegerScene} the {@link Entity} is touching.
     */
