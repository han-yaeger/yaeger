...
import nl.han.yaeger.engine.entities.EntityCollection;
...
import nl.han.yaeger.engine.entities.tilemap.TileMapListProvider;
import nl.han.yaeger.engine.scenes.delegates.BackgroundDelegate;
import nl.han.yaeger.engine.scenes.delegates.KeyListenerDelegate;
import nl.han.yaeger.guice.factories.EntityCollectionFactory;
import nl.han.yaeger.guice.factories.SceneFactory;
...
public abstract class StaticScene implements YaegerScene, KeyListener, SupplierProvider, TileMapListProvider, EntityCollectionSupplier, DependencyInjector {
     ...
     * one should be added during the game, a {@link nl.han.yaeger.engine.entities.EntitySpawner} should be used.
     * </p>
     *
