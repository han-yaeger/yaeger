package nl.han.yaeger.guice.factories;

import javafx.stage.Stage;
import nl.han.yaeger.engine.scenes.SceneCollection;

/**
 * A {@link SceneCollectionFactory} can be used to create instances of {@link nl.han.yaeger.engine.scenes.SceneCollection}.
 */
