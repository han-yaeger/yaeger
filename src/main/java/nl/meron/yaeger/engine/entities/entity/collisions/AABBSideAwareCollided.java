...
/**
 * A {@link AABBSideAwareCollided} represents an {@link nl.meron.yaeger.engine.entities.entity.Entity} that can be collided with by a
 * {@link Collider} and that is aware of which of its side the {@link Collider} had collided with. In such a case,
 * the {@link AABBSideAwareCollided} is the {@link nl.meron.yaeger.engine.entities.entity.Entity} thatgets notified of the collision and of the side.
 *
