 ...
 * direction of an {@link nl.meron.yaeger.engine.entities.entity.YaegerEntity} from the {@code constructor}.
 *
 * <p>The motion of an {@link nl.meron.yaeger.engine.entities.entity.YaegerEntity} is controlled by and delegated to a
 ...
 * the initialization phase of an {@link nl.meron.yaeger.engine.entities.entity.YaegerEntity}. This phase comes after the {@code constructor}
 * is called.
 * </p>
 *
 * <p>An {@link EntityMotionInitBuffer} therefor stores the speed and direction of an {@link nl.meron.yaeger.engine.entities.entity.YaegerEntity}
